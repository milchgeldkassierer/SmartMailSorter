...
function getCspDirectives(isDev) {
  return isDev
    ? [
        ...
        "connect-src 'self' http://localhost:3000 ws://localhost:3000 http://localhost:11434 https://api.openai.com https://api.anthropic.com https://generativelanguage.googleapis.com",
    ...
    : [
        ...
        "connect-src 'self' http://localhost:11434 https://api.openai.com https://api.anthropic.com https://generativelanguage.googleapis.com",
