import { ImapAccount, SyncResult, Email, EmailOperationResult, CategoryOperationResult, Attachment, Category } from './types';
...
declare global {
    interface Window {
        electron: {
            ...
            deleteEmail: (data: { account: ImapAccount, emailId: string, uid: number, folder?: string }) => Promise<EmailOperationResult>;
            updateEmailRead: (data: { account: ImapAccount, emailId: string, uid: number, isRead: boolean, folder?: string }) => Promise<EmailOperationResult>;
            updateEmailFlag: (data: { account: ImapAccount, emailId: string, uid: number, isFlagged: boolean, folder?: string }) => Promise<EmailOperationResult>;
