          ...
          <div className="bg-amber-50 border-l-4 border-amber-500 p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-amber-800">
                <strong>Simulation Mode:</strong> Direct IMAP access is not possible from a browser. This app uses
                Gemini AI to generate realistic email data and demonstrate how the AI sorting algorithm functions.
              </p>
            </div>
          </div>

          <p className="text-slate-600 mb-6 text-sm">
            Klicken Sie auf "Verbinden", um den Simulator zu starten. Gemini generiert Beispiel-Emails und sortiert
            diese automatisch in die richtigen Ordner.
          </p>
